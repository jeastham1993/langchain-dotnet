...
public class ChatTests
{
    ...
    public async Task TestFormat_WhenInvalidInputs_ShouldThrowError()
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(() => testPrompt.FormatPromptValue(new InputValues(
    ...
    [Fact]
    public async Task TestFormat_WhenInvalidVariables_ShouldThrowError()
    {
        var promptTemplate =
        ...
        {
            new ChatPromptTemplate(new ChatPromptTemplateInput()
            {
